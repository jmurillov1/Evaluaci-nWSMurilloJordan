...
a persistence unit "EvaluacionWSMurilloJordanPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "EvaluacionWSMurilloJordan\pom.xml":
...
artifact ("EvaluacionWSMurilloJordan.war") is already built. You can build
